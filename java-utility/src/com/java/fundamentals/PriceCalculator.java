...
public class PriceCalculator {
    static void main(String[] args) {
        ...
        System.out.println("Membership (G ,S, B, P, I:-");
        ...
        double finalValue = productPrice + centralTax + stateTax + prodcutTax;
        System.out.println(" The Final Value of the Product is= :" + (productPrice + centralTax + stateTax + prodcutTax));
    }
}